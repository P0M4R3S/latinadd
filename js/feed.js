        ...
        if (post.tipo == 3 && post.compartido) {
            ...
            <div class="container-fluid post" data-id="${post.id}">
                <div class="row perfilPost">
                    ...
                    <div class="col-8">
                        <span class="nombrePost" id="nombrePost" data-id="${post.usuario}">${nombreCompartido} ha compartido</span><br>
                ...
                <div class="row perfilPost">
                    ...
                    <div class="col-8">
                        <span class="nombrePost" id="nombrePost" data-id="${compartido.usuario}">${nombreOriginal}</span><br>
                        <span class="tiempoPost">${tiempoOriginal}</span>
                    </div>
                </div>
                <div class="row">
                    <span class="textoPost abrirPost" data-id="${post.id}">${textoOriginal}</span>
                </div>`;

            if (imagenCompartida) {
                html += `
                <div class="row rowImagenes perfilPost abrirPost" data-id="${post.id}">
                    <div class="col-12">
            ...
            html += `
                ...
                <div class="row mt-3 d-flex justify-content-around">
                    ...
                    <div class="col-2" id="btnComentar" data-id="${post.id}">
            ...
            <div class="container-fluid post" data-id="${post.id}">
                <div class="row perfilPost">
                    ...
                    <div class="col-8">
                        <span class="nombrePost" id="nombrePost" data-id="${post.usuario}">${nombre}</span><br>
                        <span class="tiempoPost">${tiempo}</span>
                    </div>
                    <div class="col-2" id="btnConfig" data-id="${post.id}" data-usuario="${post.usuario}">
                        <svg fill="lightgrey" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M8 256a56 56 0 1 1 112 0A56 56 0 1 1 8 256zm160 0a56 56 0 1 1 112 0 56 56 0 1 1 -112 0zm216-56a56 56 0 1 1 0 112 56 56 0 1 1 0-112z"/></svg>
                ...
                <div class="row">
                    <span class="textoPost abrirPost" data-id="${post.id}">${texto}</span>
                </div>`;
            ...
            html += `
                <div class="row perfilPost">
                    <div class="col-6">
                        <img src="img/reaction/reacciones.png" alt="">
                        <span class="textareaPost likesNum" data-id="${post.id}">+${likes}</span>
                    </div>
                    <div class="col-6">
...
$(document).on("click", ".abrirPost", function () {
    ...
    window.location.href = `visorPost.html?post=${id}&volver=novedades`;
});
